...
|---|---|
| Asignatura | Proyecto de Ciencia de Datos / Machine Learning |
...
|---|---|---|
| Emilio Andrade | Líder del proyecto / Project Owner | Coordinación del equipo, definición del problema de negocio, revisión de avances, Canvas ML y presentación ejecutiva. |
| Gabriela Cárdenas | Data Scientist | Definición de variable objetivo, estrategia de modelado, evaluación de métricas, selección de modelo y análisis de resultados. |
...
| Sebastián | Data Analyst | Análisis exploratorio, visualizaciones, interpretación de patrones y apoyo en dashboard. |
| David Zapata | ML Engineer / Ethics & Impact Lead | Pipelines de Machine Learning, MLflow, tuning, fairness, impacto de negocio y Model Card. |
